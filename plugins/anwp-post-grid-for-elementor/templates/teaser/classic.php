...
<div class="anwp-pg-post-teaser anwp-pg-post-teaser--layout-classic anwp-row anwp-no-gutters">
	...
	<?php if ( $post_image ) : ?>
		<div class="anwp-pg-post-teaser__thumbnail position-relative mb-2 mb-md-0 <?php echo esc_html( '1_2' === $data->post_image_width ? 'anwp-col-md-6' : 'anwp-col-md-6' ); ?>">
			<?php
			/*
			|--------------------------------------------------------------------
			| Post Category
	...
	<div class="anwp-pg-post-teaser__content <?php echo esc_attr( $post_image ? ( '1_2' === $data->post_image_width ? 'anwp-col-md-6' : 'anwp-col-md-6' ) : 'anwp-col-12' ); ?>">
			...
			<?php if ( 'yes' === $data->show_author ) : ?>
				<div class="anwp-pg-post-teaser__bottom-meta-item d-flex align-items-center mr-4">
					...
					<?php the_author_meta( 'user_nicename', $wp_post->post_author ); ?>
                      <?php echo the_field('nombre_de_la_columna') ?>  
				</div>		
			<?php endif; ?>
		...
		<div class="anwp-pg-post-teaser__excerpt mt-2"><?php echo esc_html( wp_trim_words( wp_strip_all_tags( get_the_excerpt( $wp_post ) ), 35, ' ...' ) ); ?></div>
