...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="blog-entry-inner clr <?php echo esc_attr( $inner_classes ); ?>">
		...
		<div class="blog-entry-content">
			...
			<?php
			// Category.
			get_template_part( 'partials/entry/thumbnail-style/category-columna' );

			// Title.
			get_template_part( 'partials/entry/header-columna' );

			// Content.
			get_template_part( 'partials/entry/content-columna' );
			?>
