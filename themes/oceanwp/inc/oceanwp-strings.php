	...
	function oceanwp_theme_strings( $value, $echo = true ) {
		...
		$oceanwp_strings = apply_filters(
			...
			array(
				...
				'owp-string-comment-post-button'         => apply_filters( 'ocean_comment_post_button', __( 'Enviar', 'oceanwp' ) ),
				...
				'owp-string-search-continue-reading'     => apply_filters( 'ocean_search_continue_reading', __( 'Leer más', 'oceanwp' ) ),
				'owp-string-post-continue-reading'       => apply_filters( 'ocean_post_continue_reading', __( 'Leer más', 'oceanwp' ) ),
